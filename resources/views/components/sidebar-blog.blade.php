<div class="col-xl-3 sidebar blog-sidebar-style ftco-animate bg-light pt-5">
    ...
    <div class="sidebar-box ftco-animate">
        ...
        <div class="popular-article mb-4 d-flex">
            <a class="blog-img mr-4" style="background-image: url({{ asset('images/blog/image_1.jpg') }});"></a>
            <div class="text">
        ...
        <div class="popular-article mb-4 d-flex">
            <a class="blog-img mr-4" style="background-image: url({{ asset('images/blog/image_2.jpg') }});"></a>
            <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control</a></h3>
                <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> June 28, 2019</a></div>
        ...
        <div class="popular-article mb-4 d-flex">
            <a class="blog-img mr-4" style="background-image: url({{ asset('images/blog/image_3.jpg') }});"></a>
            <div class="text">
                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control</a></h3>
                <div class="meta">
                    <div><a href="#"><span class="icon-calendar"></span> June 28, 2019</a></div>
